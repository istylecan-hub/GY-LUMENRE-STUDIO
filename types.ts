...
export type PoseStyle = 'COMMERCIAL' | 'EDITORIAL' | 'CASUAL' | 'GLAMOROUS' | 'URBAN_NIGHT' | 'STREET_STYLE' | 'FLAT_LAY' | 'EDITORIAL_HIGH_FASHION' | 'VINTAGE_RETRO' | 'ATHLETIC_SPORTY' | 'MINIMALIST_ZEN' | 'CANDID_DOCUMENTARY' | 'FIERCE_BOSS' | 'ROMANTIC_DREAMY';
